...
-- Volcando estructura de base de datos para goldenfold
CREATE DATABASE IF NOT EXISTS `goldenfold` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci */;
USE `goldenfold`;

-- Volcando estructura para tabla goldenfold.asignaciones
CREATE TABLE IF NOT EXISTS `asignaciones` (
  ...
  CONSTRAINT `fk_asignaciones_camas` FOREIGN KEY (`ubicacion`) REFERENCES `camas` (`ubicacion`),
...
-- Volcando datos para la tabla goldenfold.asignaciones: ~0 rows (aproximadamente)

-- Volcando estructura para tabla goldenfold.camas
...
-- Volcando datos para la tabla goldenfold.camas: ~0 rows (aproximadamente)

-- Volcando estructura para tabla goldenfold.consultas
...
-- Volcando datos para la tabla goldenfold.consultas: ~0 rows (aproximadamente)

-- Volcando estructura para tabla goldenfold.habitaciones
...
-- Volcando datos para la tabla goldenfold.habitaciones: ~0 rows (aproximadamente)

-- Volcando estructura para tabla goldenfold.historialaltas
...
-- Volcando datos para la tabla goldenfold.historialaltas: ~0 rows (aproximadamente)

-- Volcando estructura para tabla goldenfold.ingresos
...
-- Volcando datos para la tabla goldenfold.ingresos: ~0 rows (aproximadamente)

-- Volcando estructura para tabla goldenfold.pacientes
CREATE TABLE IF NOT EXISTS `pacientes` (
  ...
  `estado` enum('Registrado','En consulta','Ingresado','Alta') DEFAULT 'Registrado',
...
-- Volcando datos para la tabla goldenfold.pacientes: ~15 rows (aproximadamente)
INSERT INTO `pacientes` (`id_paciente`, `nombre`, `dni`, `fecha_nacimiento`, `seguridad_social`, `estado`, `fecha_registro`, `direccion`, `telefono`, `email`, `historial_medico`) VALUES
	...
	(37, 'Ana Gutiérrez', '67890123G', '1988-06-05', '678901234567', 'Registrado', '2024-09-16 15:50:04', 'Plaza Mayor 4, Bilbao', '660432567', 'ana.gutierrez@example.com', 'Historial médico de Ana Gutiérrez.'),
...
-- Volcando estructura para tabla goldenfold.roles
...
-- Volcando datos para la tabla goldenfold.roles: ~4 rows (aproximadamente)
...
-- Volcando estructura para tabla goldenfold.usuarios
...
-- Volcando datos para la tabla goldenfold.usuarios: ~12 rows (aproximadamente)
